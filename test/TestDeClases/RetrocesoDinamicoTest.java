...
public class RetrocesoDinamicoTest {
	...
	@Test
	public void jugadorCaeEnRetrocesoDinamicoYConDados5conProdiedades10NoMoverseTest(){
		Tablero tablero = Tablero.getInstance();
		Jugador jugador = new Jugador("jugador1");
		tablero.agregarJugador(jugador);
		
		jugador.aumentarNumeroDePropiedades(10);
		jugador.setValorDados(5);
		tablero.moverJugador(jugador, 18);
		
		Assert.assertEquals(18,tablero.obtenerPosicion(jugador));
	}
